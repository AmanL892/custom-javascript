webpackJsonp([14], {
  0: function(e, t, i) {
    i(1448), i(1483), i(1484), i(1485), i(1486), e.exports = i(1487)
  },
  289: function(e, t, i) {
    "use strict";
    var s = i(8),
    ...
    var s = i(8),
      ...
      _ = a.extend({
        ...
        onImageUploadClick: function(e) {
          ...
          if (this.imageUploadEl = s(".image-upload-input"), this.documentPreviewEl = s(".document-upload-preview"), this.imagePreviewEl = s(".image-upload-preview"), t.files && t.files[0]) {
            ...
            if (r.trigger("drawerform:errortag:remove", {
                field: this.imageUploadEl
              }), this.imageUploadEl.addClass("hidden"), t.files[0].type.match(/^image/)) {
            ...
            } else this.documentPreviewEl.removeClass("hidden"), this.documentPreviewEl.find("img").attr("src", "https://assets.tumblr.com/images/check.png"), this.documentPreviewEl.addClass("shown"), this.documentPreviewEl.find("span").html(t.files[0].name)
          }
        },
        onRemoveImageClick: function(e) {
          e.preventDefault();
          var t = s(".image-upload-input input");
          t.replaceWith(t.val("").clone(!0)), s(".image-upload-input input").trigger("change"), this.imagePreviewEl.removeClass("shown"), this.documentPreviewEl.removeClass("shown"), this.imageUploadEl.removeClass("hidden")
        }
      });
    e.exports = _
  },
    ...
    var s = i(8),
      ...
      u = a.extend({
        events: {
          ...
          'change [data-validate-input="input-date"]': "fieldValidationHandler",
          'keyup [data-validate-input="name"]': "fieldValidationHandler",
          'blur [data-validate-input="name"]': "fieldValidationHandler",
          'keyup [data-validate-input="lename"]': "fieldValidationHandler",
          'blur [data-validate-input="lename"]': "fieldValidationHandler",
          ...
          'keyup [data-validate-input="letext-abuse-form"]': "fieldValidationHandler",
          'blur [data-validate-input="letext-abuse-form"]': "fieldValidationHandler",
        ...
        isFieldValid: function(e, t, i) {
          ...
          switch (t) {
            ...
            case "url":
              ...
              break;
            case "tumblr_url":
              s = l.isTumblrPostOrMediaUrl(e) || l.isTumblrPostOrMediaUrl(decodeURIComponent(e));
              break;
            case "checkbox":
      ...
      h = n.extend({
        ...
        __clickOpen: function(e) {
          ...
          this.isIos() && setTimeout(function() {
            document.webkitHidden || document.hidden || confirm(o("Open in the app store?")) && (document.location.href = t.get("install_url_open_failed"))
          }, 200)
        },
        ...
        setCookie: function() {
          var e = new Date;
          e.setDate(e.getDate() + 3), a.set("hide_download_app_prompt", "1", e)
        },
        showBanner: function() {
          r(document.documentElement).addClass("mobile-app-banner-visible")
        },
        hideBanner: function() {
          r(document.documentElement).removeClass("mobile-app-banner-visible")
        },
        isIos: function() {
        ...
        initialize: function(e) {
          s.extend(this.attributes, e), this.$el.addClass(this.get("type")), "app-gate" === this.get("type") ? this.get("has_app") ? this.subViews.bannerInternals = new u(e) : this.subViews.bannerInternals = new p(e) : this.subViews.bannerInternals = new d(e)
        },
        render: function() {
          return !a.get("hide_download_app_prompt") && (this.showBanner(), this.$el.html(this.template(this.toJSON())), this.attachSubViews(), this)
        }
      });
    e.exports = h
  },
  ...
  1273: function(module, exports, __webpack_require__) {
    ...
    module.exports = Function(_keys(_imports), "return " + function(obj) {
      ...
      with(obj) __p += '<div class="mobile-banner-body"><span class="mobile-banner-heading">' + __e(__("Use the Tumblr app!")) + '</span><span class="mobile-banner-subheading">' + __e(__("Find communities and join group chats.")) + '</span></div><div class="mobile-banner-controls"><a href="' + __e(open_url) + '" class="open mobile-banner-button secondary-cta tx-button" role="button">' + __e(__("Open")) + '</a><a href="' + __e(install_url) + '" class="install mobile-banner-button primary-cta tx-button" role="button">' + __e(__("Install the app")) + "</a> ", show_close_button && (__p += ' <a href="#" class="mobile-banner-close"></a> '), __p += " </div>";
      return __p
    }.toString()).apply(void 0, _values(_imports))
  },
  1274: function(e, t, i) {
  ...
  1434: function(e, t, i) {
    ...
    var s = i(8),
      ...
      f = h.extend({
        ...
        initialize: function(e) {
          try {
            h.prototype.initialize.call(this, e), this.set("suggestionsShown", !1), this.on("change:complete", this.updateSubmitButton), this.set("wasFormTouched", !1), this.set("wasFaqLoaded", !1), this.set("mobileMode", e.mobileMode || !1), a.on("drawer:close", o.bind(this.teardown, this));
            var t = n.get("Components/HelpForm");
            this.templateAttributes.email = t.email, this.templateAttributes.tumblelogs = t.tumblelogs, this.templateAttributes.languageNotice = t.language_notice, this.templateAttributes.categories = t.category_opt, this.templateAttributes.preSelectedCategory = e && e.category ? e.category : "", this.templateAttributes.supportsFileChooser = this.supportsFileChooser(), this.templateAttributes.recaptcha = t.recaptcha, this.captcha = new m, this.lang = t.lang, this.setUpResponseHandler(), s(".contact_button_static").remove(), s(".static_help_form").remove()
          } catch (e) {
            this.onCatchFallBack(e)
          }
        },
        onCatchFallBack: function(e) {
          window.location && (this.get("mobileMode") && "/help" !== window.location.pathname ? o.defer(function() {
            s(".help-form").remove()
  ...
  1449: function(e, t, i) {
    ...
    var s = i(8),
      ...
      p = n.extend({
        ...
        register: function() {
          this._createAboutTumblr(!1), this.exploreButton = new d({
            el: s(".signup_forms")
          })
        },
        login: function() {
